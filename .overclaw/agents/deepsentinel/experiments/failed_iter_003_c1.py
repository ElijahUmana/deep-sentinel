...
def run(input: dict) -> dict:
    ...
    # Call LLM with enhanced system prompt for better raw_analysis content
    response = call_llm(
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Always provide detailed analysis in your response even when no vulnerabilities are found. "
                    "Explain what you checked and why the code is safe.\n\n"
