        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Be conservative in vulnerability detection. Only flag clear, exploitable vulnerabilities with high confidence. Commented-out code, template helpers without user input context, and other edge cases should not be flagged unless there is clear evidence of exploitability.\n\n"
                    "Consider the file path and context when assessing risk. Template helpers, configuration examples, and commented code may not represent actual vulnerabilities unless there is clear evidence of user input flow or production usage.\n\n"
