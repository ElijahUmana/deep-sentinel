        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- CWE-798: Hardcoded credentials (passwords, API keys, secrets in source). CWE-798 includes hardcoded credentials even when commented out, as they represent security risks in source code.\n"
                    ...
                    "\"recommendation\": \"BLOCK|REVIEW|APPROVE\", \"raw_analysis\": \"detailed security assessment reasoning\"}\n\n"
                    "Always include a raw_analysis field with your detailed security assessment reasoning, including why you flagged or didn't flag specific patterns.\n\n"
                    "Rules:\n"
                    ...
                    "- If the code has no vulnerabilities, return {\"findings\": [], \"risk_level\": \"NONE\", \"recommendation\": \"APPROVE\", \"raw_analysis\": \"detailed explanation of why no vulnerabilities were found\"}"
                ),
            },
            {
                "role": "user",
