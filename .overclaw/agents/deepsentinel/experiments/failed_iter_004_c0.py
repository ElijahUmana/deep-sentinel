        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "IMPORTANT: Only report findings for ACTIVE vulnerabilities in executable code. "
                    "Do NOT flag commented-out code, documentation examples, or inactive code blocks unless they pose a real, immediate security risk. "
