        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- Commented-out credentials (e.g., '# password = \"admin123\"') should NOT be flagged as vulnerabilities since they are not active code\n"
                    "- XSS in template helpers without clear user input context should typically be flagged as MEDIUM risk, not HIGH\n"
                    "- Only flag actual executable code that poses security risks\n\n"
                    ...
                    "Each finding must include ALL fields: severity, cwe_id, title, line_number, description, fix, confidence. Do not omit any fields.\n\n"
                    "Rules:\n"
