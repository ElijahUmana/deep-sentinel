        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Be conservative in vulnerability detection. Only report findings for clear, exploitable vulnerabilities with direct security impact. Commented-out code, template helpers without user input, and safe utility functions should not generate findings unless there is clear evidence of vulnerability.\n\n"
