        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- Only report findings for clear, unambiguous security vulnerabilities. When in doubt about context or if code appears to be example/test code, err on the side of not reporting vulnerabilities.\n"
                    "- Consider the file path and context when assessing severity. Template helpers, configuration examples, and utility functions may have different risk profiles than production application code.\n"
                    "- Be especially conservative with example code, documentation snippets, test files, or configuration templates.\n\n"
