        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- Only report findings for clear, unambiguous security vulnerabilities\n"
                    "- When in doubt about context or if code appears to be example/test code, err on the side of not reporting vulnerabilities\n"
                    "- Consider the file path and context when assessing severity\n"
                    "- Template helpers, configuration examples, and utility functions may have different risk profiles than production application code\n"
                    "- Example code, documentation snippets, and test files should be evaluated with appropriate context\n\n"
